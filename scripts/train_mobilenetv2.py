"""
Train MobileNetV2Transfer for Brain MRI binary classification.

This script uses the reusable project modules:
- models/mobilenetv2_transfer.py
- utils/dataset.py
- utils/trainer.py
"""
...
EPOCHS = 15
MODEL_SAVE_PATH = "results/models/mobilenetv2_best.pth"
...
def print_configuration(device):
    ...
    print("=" * 50)
    print("Model: MobileNetV2Transfer")
...
def main():
    """Run MobileNetV2Transfer training."""
    try:
