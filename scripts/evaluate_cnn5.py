"""
Evaluate the saved CNN5 model on the Brain MRI test dataset.

This script loads the best CNN5 checkpoint and computes standard
...
EVALUATION_OUTPUT_PATH = Path("results/evaluation/cnn5_evaluation.txt")
BATCH_SIZE = 32
...
def load_model(checkpoint, device):
    """Create CNN5 and load the saved model weights."""
...
def main():
    """Evaluate the saved CNN5 model on the test dataset."""
    try:
