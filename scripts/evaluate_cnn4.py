"""
Evaluate the saved CNN4 model on the Brain MRI test dataset.

This script loads the best CNN4 checkpoint and computes standard
...
CHECKPOINT_PATH = Path("results/models/cnn4_best.pth")
EVALUATION_OUTPUT_PATH = Path("results/evaluation/cnn4_evaluation.txt")
BATCH_SIZE = 32
...
def load_model(checkpoint, device):
    """Create CNN4 and load the saved model weights."""
...
def main():
    """Evaluate the saved CNN4 model on the test dataset."""
    try:
