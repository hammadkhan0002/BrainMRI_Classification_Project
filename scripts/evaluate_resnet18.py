"""
Evaluate the saved ResNet18Transfer model on the Brain MRI test dataset.

This script loads the best ResNet18Transfer checkpoint and computes standard
...
EVALUATION_OUTPUT_PATH = Path("results/evaluation/resnet18_evaluation.txt")
BATCH_SIZE = 32
...
def load_model(checkpoint, device):
    """Create ResNet18Transfer and load the saved model weights."""
...
def format_metrics(metrics, class_names):
    ...
    lines = [
        "ResNet18Transfer Test Evaluation",
        "=" * 20,
...
def main():
    """Evaluate the saved ResNet18Transfer model on the test dataset."""
    try:
