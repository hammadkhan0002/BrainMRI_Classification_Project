"""
Train SqueezeNetTransfer for Brain MRI binary classification.

This script uses the reusable project modules:
- models/squeezenet_transfer.py
- utils/dataset.py
- utils/trainer.py
"""
...
EPOCHS = 15
MODEL_SAVE_PATH = "results/models/squeezenet_best.pth"
...
def print_configuration(device):
    ...
    print("=" * 50)
    print("Model: SqueezeNetTransfer")
...
def main():
    """Run SqueezeNetTransfer training."""
    try:
