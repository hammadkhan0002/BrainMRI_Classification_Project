"""
Evaluate the saved CNN3 model on the Brain MRI test dataset.

This script loads the best CNN3 checkpoint and computes standard
...
CHECKPOINT_PATH = Path("results/models/cnn3_best.pth")
EVALUATION_OUTPUT_PATH = Path("results/evaluation/cnn3_evaluation.txt")
BATCH_SIZE = 32
...
def load_model(checkpoint, device):
    """Create CNN3 and load the saved model weights."""
...
def main():
    """Evaluate the saved CNN3 model on the test dataset."""
    try:
