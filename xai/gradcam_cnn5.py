"""
Generate Grad-CAM visualizations for CNN5 Brain MRI classification.

Usage:
    python xai/gradcam_cnn5.py path/to/image.png

Outputs are saved to:
    results/gradcam/cnn5/
"""
...
CHECKPOINT_PATH = Path("results/models/cnn5_best.pth")
OUTPUT_DIR = Path("results/gradcam/cnn5")
IMAGE_SIZE = (224, 224)
...
def main(image_path):
    ...
    try:
        ...
        gradcam = GradCAM(model=model, target_layer=model.features[16])
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage example:")
        print("python xai/gradcam_cnn5.py data/split/test/tumor/example.png")
        sys.exit(1)
